...
class FLVOffsetStream extends TransformStream {
    constructor({ timestampOffset = 0, mediaTagsOnly = true, outputBinary = false } = {}, ...strategies) {
        super({
     ...
     */
    static mergeStream(flvStreams, ...strategies) {
...
//# sourceMappingURL=flv-offset-stream.js.map