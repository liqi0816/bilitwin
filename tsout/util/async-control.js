...
const queueAsync_UNIT_TEST = () => {
    const badnight = queueAsync(i => sleep(i).then(() => { if (Math.random() > 0.5)
        throw new Error('uncaught error test: you should expect a console error message.'); }));
    badnight(1000);
    badnight(1000);
    badnight(1000);
    badnight(1000);
...
//# sourceMappingURL=async-control.js.map