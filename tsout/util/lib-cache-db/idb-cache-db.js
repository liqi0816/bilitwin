...
class IDBCacheDB {
    ...
    async createData(item, name = item.name) {
        ...
        const reqCascade = new Promise((resolve, reject) => {
            ...
            const onsuccess = (e = new Event('zerowrite')) => {
    ...
    async getData(name) {
        ...
        const reqCascade = new Promise((resolve, reject) => {
            ...
            probe.onsuccess = e => {
                ...
                const onsuccess = ({ target: { result: { item } } }) => {
                    dataChunks.push(item);
                    if (dataChunks.length == numChunks)
                        return resolve(dataChunks);
...
//# sourceMappingURL=idb-cache-db.js.map