...
import BaseDetailedFetchBlob from './lib-detailed-fetch-blob/base-detailed-fetch-blob.js';
 ...
 */
const DetailedFetchBlob: typeof BaseDetailedFetchBlob = StreamDetailedFetchBlob.isSupported ? StreamDetailedFetchBlob : FirefoxDetailedFetchBlob.isSupported ? FirefoxDetailedFetchBlob : StreamDetailedFetchBlob;
