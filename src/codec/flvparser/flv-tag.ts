...
class FLVTag {
    tagHeader: TwentyFourDataView
    tagData: TwentyFourDataView
    previousSize: TwentyFourDataView

    constructor(dataView: DataView, currentOffset = 0) {
    ...
    getDuration() {
        ...
        if (anchorIndex === -1) throw new Error('getDurationAndView: cannot find duration metainfo section');
    ...
    setCombinedTimestamp(timestamp: number) {
